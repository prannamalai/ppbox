	...
	*/
	public function callPaymentDetails( $payKey, $transactionId, $trackingId )
	{
		...
		*/
		...
		$resArray= array("responseEnvelope.ack" => "success",
		"paymentInfoList.paymentInfo(0).receiver.email"=> DUMMY_EMAILID,
		"paymentInfoList.paymentInfo(0).transactionStatus" => AP_TXN_STATUS,
		"status" => AP_TXN_STATUS);		
		/* Return the response array */
		return $resArray;
	}
	...
	*/
						...
						$memo, $pin, $preapprovalKey, $reverseAllParallelPaymentsOnError, $senderEmail, $trackingId )
	{
		...
		*/
		...
		/* Return the response array */
		$resArray=array("responseEnvelope.ack" => "success",
						"payKey" =>  PAY_KEY_PREIX.Util::randomAlphaNum(PAY_KEY_LENGTH),
						"paymentExecStatus" => AP_STUB_PAYMENT_EXEC_STATUS);		
